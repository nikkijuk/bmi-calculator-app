...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(bmiLevel) => "${Intl.select(bmiLevel, {'t3': 'Starkes Untergewicht', 't2': 'Moderate Untergewicht', 't1': 'Leichte Untergewicht', 'n': 'Normalgewicht', 'po': 'Übergewicht', 'o1': 'Adipositas Grad I', 'o2': 'Adipositas Grad II', 'o3': 'Adipositas Grad IIII', 'other': 'N/A', })}";

  static m1(bmi) => "bmi ist ${bmi}";
